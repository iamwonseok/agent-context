...
if [[ "$GLOBAL_INSTALL" == "true" ]]; then
    ...
    echo "  export PATH=\"\$HOME/.agent/tools/agent/bin:\$HOME/.agent/tools/pm/bin:\$HOME/.agent/tools/lint/bin:\$PATH\""
    echo ""
    exit 0
fi
...
echo "   export PATH=\"${AGENT_PATH}/tools/agent/bin:${AGENT_PATH}/tools/pm/bin:${AGENT_PATH}/tools/lint/bin:\$PATH\""
...
echo "   agnt-c dev start TASK-123"
echo ""
echo "========================================="
